...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const bulkActionBtns = document.querySelectorAll('#bulkVerify, #bulkActivate, #bulkDeactivate');
    ...
    if (editUserBtn) {
        editUserBtn.addEventListener('click', function () {
            ...
            // Show edit modal
            document.getElementById('addUserModalLabel').textContent = 'Chỉnh sửa thông tin khách hàng';
    ...
    function setupActionBtns(btns, action, message, warning, btnClass) {
        btns.forEach(btn => {
            btn.addEventListener('click', function (e) {
                ...
                document.getElementById('warningMessage').style.display = warning ? 'block' : 'none';
        ...
        btn.addEventListener('click', function () {
            ...
            switch (action) {
                ...
                case 'deactivate':
                    ...
                    warning = 'Khóa tài khoản sẽ ngăn người dùng đăng nhập và sử dụng dịch vụ.';
                    btnClass = 'btn-danger';
                    break;
            }
    ...
    if (confirmActionBtn) {
        confirmActionBtn.addEventListener('click', function () {
            ...
            if (isBulk) {
                ...
                const selectedUserIds = [...userCheckboxes].filter(cb => cb.checked)
                    .map(cb => cb.closest('tr').querySelector('.dropdown button').getAttribute('data-user-id'));
